...
<div id="main-main" class="container"> 
        <main>
            <h2 class="text-center">Cơ Quan</h2>
            <div>
                <a href="add_cq.php" class="btn btn-success">Thêm Cơ Quan Mới</a>
            </div>
            <div class="CoQuan">
                ...
                <tbody>
                    ...
                    ?>
                                <tr>
                                    ...
                                    <td><a href="delete_cq.php?id=<?php echo $row['id']; ?>"><i class="bi bi-archive-fill"></i></a></td>
                                </tr>
                    <?php
                            $i++;
                            }
